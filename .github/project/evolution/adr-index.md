...
| ADR-260050 | Consolidated Authentication Strategy | Accepted | 2026-06-08 | ADR-260014, ADR-260048, ADR-260049 | - | Unifies credential (username/email + password), Google Sign-In, and one-click demo mode into a single SignInPage; isDemoSession flag prevents demo token from persisting to localStorage. |
