...
| ADR-260039 | Flow View Directional Projection, Relayout Contract, and Visual Grammar Baseline | Accepted | 2026-05-19 | - | - | Defines Flow-view projection filtering, left-to-right relayout contract, and Flow-specific edge/handle grammar. |
